...
static TEMPLATE_REGISTRY: &[(&str, &str)] = &[
    (
        "system.md",
        "Main system prompt that defines CodeMindX's personality and behavior",
    ),
    (
        "compaction.md",
    ...
    (
        "apps_create.md",
        "Prompt for generating new CodeMindX apps based on the user instructions",
    ),
    (
        "apps_iterate.md",
        "Prompt for updating existing CodeMindX apps based on feedback",
    ),
    (
        "permission_judge.md",
    ...
    (
        "plan.md",
        "Prompt used when CodeMindX creates step-by-step plans. CLI only",
    ),
    (
